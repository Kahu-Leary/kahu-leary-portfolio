        ...
        <main className='bg-gray-200 min-h-screen p-12'>
            <article className='container shadow-lg mx-auto bg-gray-400 rounded-lg'>
                <header className='relative'>
                    ...
                    <img className='w-full object-cover rounded-t' style={{height: '400px'}} src={singlePost.mainImage.asset.url} alt={singlePost.title}/>
                </header>
                <div className='px-16 lg:px-48 py-12 lg:py-20 prose lg:prose-xl max-w-full'>
                    <BlockContent blocks={singlePost.body} projectId='ttbbel5d' dataset='production' />
                </div>
            </article>
        </main>
    )
